...
public class ItemService {
    ...
    public ArrayList<Item> getItemListTest(String id) {
        ...
        String prompt = "\\n'" + itemName + "'을 구입했을때 활용방안을 여러가지 설명해줘. 활용방안을 자세하게 100자 이내로 답변해줘. 답변할때 내가 말한 상품의 단위는 빼줘." +
                "\\n앞에 상품과 함께 추가로 구매하면 좋을것 같은 상품도 추천해줘. 추천상품을 자세하게 100자 이내로 설명해주고, 답변 맨 뒤에 추천상품 id 목록을 띄어쓰기 없이 콤마로 구분해서 추가해줘. 적어도 5개 이상의 상품을 추천해주고." +
    ...
    public String getItemListTest2(String id) {
